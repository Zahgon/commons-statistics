 ...
 */
@Command(name = "cauchy", description = "Cauchy distribution.", subcommands = { CauchyCommand.Check.class, CauchyCommand.PDF.class, CauchyCommand.LPDF.class, CauchyCommand.CDF.class, CauchyCommand.SF.class, CauchyCommand.ICDF.class, CauchyCommand.ISF.class })
class CauchyCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        static class Params {
             ...
             */
            @Option(names = { "--location" }, arity = "1..*", split = ",", description = { "location (default: ${DEFAULT-VALUE})." })
            private double[] location = { 0, 0, 0, -2 };

            /**
             * The distribution scale.
             */
            @Option(names = { "--scale" }, arity = "1..*", split = ",", description = { "scale (default: ${DEFAULT-VALUE})." })
     ...
     */
    @Command(name = "check", hidden = true, description = "Cauchy distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Cauchy distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Cauchy distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Cauchy distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Cauchy distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Cauchy distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Cauchy distribution inverse SF.")
