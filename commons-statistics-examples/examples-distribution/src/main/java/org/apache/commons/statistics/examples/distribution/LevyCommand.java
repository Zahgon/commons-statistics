 ...
 */
@Command(name = "levy", description = "Levy distribution.", subcommands = { LevyCommand.Check.class, LevyCommand.PDF.class, LevyCommand.LPDF.class, LevyCommand.CDF.class, LevyCommand.SF.class, LevyCommand.ICDF.class, LevyCommand.ISF.class })
class LevyCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        static class Params {
             ...
             */
            @Option(names = { "-c", "--scale" }, arity = "1..*", split = ",", description = { "scale (default: ${DEFAULT-VALUE})." })
     ...
     */
    @Command(name = "check", hidden = true, description = "Levy distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Levy distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Levy distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Levy distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Levy distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Levy distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Levy distribution inverse SF.")
