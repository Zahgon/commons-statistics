 ...
 */
@Command(name = "normal", aliases = { "norm" }, description = "Normal distribution.", subcommands = { NormalCommand.Check.class, NormalCommand.PDF.class, NormalCommand.LPDF.class, NormalCommand.CDF.class, NormalCommand.SF.class, NormalCommand.ICDF.class, NormalCommand.ISF.class })
class NormalCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        static class Params {
            ...
            private double[] // Define using variance
            sigma = { Math.sqrt(0.2), 1, Math.sqrt(5), Math.sqrt(0.5) };
        }
     ...
     */
    @Command(name = "check", hidden = true, description = "Normal distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Normal distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Normal distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Normal distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Normal distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Normal distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Normal distribution inverse SF.")
