 ...
 */
@Command(name = "gumbel", description = "Gumbel distribution.", subcommands = { GumbelCommand.Check.class, GumbelCommand.PDF.class, GumbelCommand.LPDF.class, GumbelCommand.CDF.class, GumbelCommand.SF.class, GumbelCommand.ICDF.class, GumbelCommand.ISF.class })
class GumbelCommand extends AbstractDistributionCommand {
     ...
     */
    @Command(name = "check", hidden = true, description = "Gumbel distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Gumbel distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Gumbel distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Gumbel distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Gumbel distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Gumbel distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Gumbel distribution inverse SF.")
