 ...
 */
@Command(name = "lognormal", aliases = { "lnorm", "logn" }, description = "Log-normal distribution.", subcommands = { LogNormalCommand.Check.class, LogNormalCommand.PDF.class, LogNormalCommand.LPDF.class, LogNormalCommand.CDF.class, LogNormalCommand.SF.class, LogNormalCommand.ICDF.class, LogNormalCommand.ISF.class })
class LogNormalCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        static class Params {
             ...
             */
            @Option(names = { "-m", "--mu", "--mean" }, arity = "1..*", split = ",", description = { "mean of variable's natural logarithm (default: ${DEFAULT-VALUE})." })
            private double[] mu = { 0 };

            /**
             * The distribution sigma.
             */
            @Option(names = { "-s", "--sigma" }, arity = "1..*", split = ",", description = { "standard deviation of variable's natural logarithm (default: ${DEFAULT-VALUE})." })
     ...
     */
    @Command(name = "check", hidden = true, description = "Log-normal distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Log-normal distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Log-normal distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Log-normal distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Log-normal distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Log-normal distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Log-normal distribution inverse SF.")
