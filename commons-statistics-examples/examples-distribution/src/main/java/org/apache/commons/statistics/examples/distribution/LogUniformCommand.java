 ...
 */
@Command(name = "logunif", aliases = { "reciprocal" }, description = "Log uniform distribution.", subcommands = { LogUniformCommand.Check.class, LogUniformCommand.PDF.class, LogUniformCommand.LPDF.class, LogUniformCommand.CDF.class, LogUniformCommand.SF.class, LogUniformCommand.ICDF.class, LogUniformCommand.ISF.class })
class LogUniformCommand extends AbstractDistributionCommand {
     ...
     */
    @Command(name = "check", hidden = true, description = "Log uniform distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Log uniform distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Log uniform distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Log uniform distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Log uniform distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Log uniform distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Log uniform distribution inverse SF.")
