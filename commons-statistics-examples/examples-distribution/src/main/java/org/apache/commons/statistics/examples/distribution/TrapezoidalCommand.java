 ...
 */
@Command(name = "trapezoidal", aliases = { "trap" }, description = "Trapezoidal distribution.", subcommands = { TrapezoidalCommand.Check.class, TrapezoidalCommand.PDF.class, TrapezoidalCommand.LPDF.class, TrapezoidalCommand.CDF.class, TrapezoidalCommand.SF.class, TrapezoidalCommand.ICDF.class, TrapezoidalCommand.ISF.class })
class TrapezoidalCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        static class Params {
             ...
             */
            @Option(names = { "-b", "--shape1" }, paramLabel = "b", arity = "1..*", split = ",", description = { "constant start (default: ${DEFAULT-VALUE})." })
            private double[] start = { -1.5, 0, 1 };

            /**
             * The end of the density constant region.
             */
            @Option(names = { "-c", "--shape2" }, paramLabel = "c", arity = "1..*", split = ",", description = { "constant end (default: ${DEFAULT-VALUE})." })
            private double[] end = { 2.5, 2, 3 };

            /**
             * The distribution upper limit.
             */
            @Option(names = { "-d", "--upper" }, paramLabel = "d", arity = "1..*", split = ",", description = { "upper bound (default: ${DEFAULT-VALUE})." })
     ...
     */
    @Command(name = "check", hidden = true, description = "Trapezoidal distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Trapezoidal distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Trapezoidal distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Trapezoidal distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Trapezoidal distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Trapezoidal distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Trapezoidal distribution inverse SF.")
