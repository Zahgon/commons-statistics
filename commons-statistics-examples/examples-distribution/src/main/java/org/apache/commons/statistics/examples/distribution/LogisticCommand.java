 ...
 */
@Command(name = "logistic", description = "Logistic distribution.", subcommands = { LogisticCommand.Check.class, LogisticCommand.PDF.class, LogisticCommand.LPDF.class, LogisticCommand.CDF.class, LogisticCommand.SF.class, LogisticCommand.ICDF.class, LogisticCommand.ISF.class })
class LogisticCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        static class Params {
             ...
             */
            @Option(names = { "-s", "--scale" }, arity = "1..*", split = ",", description = { "scale (default: ${DEFAULT-VALUE})." })
     ...
     */
    @Command(name = "check", hidden = true, description = "Logistic distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Logistic distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Logistic distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Logistic distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Logistic distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Logistic distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Logistic distribution inverse SF.")
