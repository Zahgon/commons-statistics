 ...
 */
@Command(name = "unif", aliases = { "uniform", "rectangular" }, description = "Continuous uniform distribution.", subcommands = { UniformContinuousCommand.Check.class, UniformContinuousCommand.PDF.class, UniformContinuousCommand.LPDF.class, UniformContinuousCommand.CDF.class, UniformContinuousCommand.SF.class, UniformContinuousCommand.ICDF.class, UniformContinuousCommand.ISF.class })
class UniformContinuousCommand extends AbstractDistributionCommand {
     ...
     */
    @Command(name = "check", hidden = true, description = "Continuous uniform distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Continuous uniform distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Continuous uniform distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Continuous uniform distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Continuous uniform distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Continuous uniform distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Continuous uniform distribution inverse SF.")
