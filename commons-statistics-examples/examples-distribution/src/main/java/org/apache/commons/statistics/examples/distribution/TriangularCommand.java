 ...
 */
@Command(name = "triangular", aliases = { "tri" }, description = "Triangular distribution.", subcommands = { TriangularCommand.Check.class, TriangularCommand.PDF.class, TriangularCommand.LPDF.class, TriangularCommand.CDF.class, TriangularCommand.SF.class, TriangularCommand.ICDF.class, TriangularCommand.ISF.class })
class TriangularCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        static class Params {
             ...
             */
            @Option(names = { "-c", "--mode" }, paramLabel = "c", arity = "1..*", split = ",", description = { "mode (default: ${DEFAULT-VALUE})." })
     ...
     */
    @Command(name = "check", hidden = true, description = "Triangular distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Triangular distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Triangular distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Triangular distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Triangular distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Triangular distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Triangular distribution inverse SF.")
