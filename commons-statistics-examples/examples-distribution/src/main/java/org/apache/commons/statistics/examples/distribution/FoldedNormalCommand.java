...
class FoldedNormalCommand extends AbstractDistributionCommand {
     ...
     */
    @Command(name = "check", hidden = true, description = "Folded normal distribution verification checks.")
     ...
     * PDF command.
     */
    @Command(name = "pdf", description = "Folded normal distribution PDF.")
     ...
     * LPDF command.
     */
    @Command(name = "lpdf", description = "Folded normal distribution natural logarithm of the PDF.")
     ...
     * CDF command.
     */
    @Command(name = "cdf", description = "Folded normal distribution CDF.")
     ...
     * SF command.
     */
    @Command(name = "sf", description = "Folded normal distribution survival probability.")
     ...
     * ICDF command.
     */
    @Command(name = "icdf", description = "Folded normal distribution inverse CDF.")
     ...
     * ISF command.
     */
    @Command(name = "isf", description = "Folded normal distribution inverse SF.")
